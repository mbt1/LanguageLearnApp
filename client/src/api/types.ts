...
// Review schedule
export type ConceptProgressDetail = components['schemas']['ConceptProgressDetail']
export type ReviewScheduleResponse = components['schemas']['ReviewScheduleResponse']
